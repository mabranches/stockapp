...
RSpec.describe WarehousesController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested warehouse as @warehouse" do
      warehouse = Warehouse.create! valid_attributes
      get :show, {:id => warehouse.to_param}, valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested warehouse as @warehouse" do
      warehouse = Warehouse.create! valid_attributes
      get :edit, {:id => warehouse.to_param}, valid_session
      expect(assigns(:warehouse)).to eq(warehouse)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Warehouse" do
        expect {
          post :create, {:warehouse => valid_attributes}, valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved warehouse as @warehouse" do
        post :create, {:warehouse => invalid_attributes}, valid_session
        expect(assigns(:warehouse)).to be_a_new(Warehouse)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested warehouse" do
        warehouse = Warehouse.create! valid_attributes
        put :update, {:id => warehouse.to_param, :warehouse => new_attributes}, valid_session
        warehouse.reload
      ...
      it "assigns the requested warehouse as @warehouse" do
        warehouse = Warehouse.create! valid_attributes
        put :update, {:id => warehouse.to_param, :warehouse => valid_attributes}, valid_session
        expect(assigns(:warehouse)).to eq(warehouse)
      end
    ...
    context "with invalid params" do
      it "assigns the warehouse as @warehouse" do
        warehouse = Warehouse.create! valid_attributes
        put :update, {:id => warehouse.to_param, :warehouse => invalid_attributes}, valid_session
        expect(assigns(:warehouse)).to eq(warehouse)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested warehouse" do
      warehouse = Warehouse.create! valid_attributes
      expect {
        delete :destroy, {:id => warehouse.to_param}, valid_session
      }.to change(Warehouse, :count).by(-1)
    end
